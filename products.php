...
if ($select) {
    ...
    if ($num_rows > 0) {
        while ($fetch = mysqli_fetch_assoc($select)) {
            ...
            <a href='update.php?ProductId=" . $fetch['ProductId'] . "' class='update'>Update</a>
            <a href='delete.php?ProductId=" . $fetch['ProductId'] . "' class='delete'>Delete</a>
            <a href='import.php?ProductId=" . $fetch['ProductId'] . "' class='import'>Import</a>
            </td>
        </tr></br>";
        }
    } else {
